...
podam podziały Simsa (imię i nazwisko!) i Zimmermana (imię i nazwisko).
Pierwszy z nich dzieli interaktywność na 3 poziomy:
\begin{itemize}
\item reaktywny
\item koaktywny
\item proaktywny
\end{itemize}
Z pierwszym poziomem mamy do czynienia...
