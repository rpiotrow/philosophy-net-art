...
na samym pomyśle, idei, bez dalszej
realizacji\footnote{Ewa Wójtowicz, \textit{Net art}, Kraków 2008, s. 141-156}.
...
można również odczytywać jako dostosowanie dzieła do cech sztuki
internetu.
...
zaczyna życ swoim życiem, ponieważ odbiorcy bardzo często mają możliwości
zmia w tychże dziełach. Ciekawymi przykładami są tutaj niektóre prace
...
sztuki\footnote{Ryszard Kluszczyński, \textit{Sztuka interaktywna}, Warszawa 2010, s. 66-76}.
...
\footnote{Ryszard Kluszczyński, \textit{Sztuka interaktywna}, Warszawa 2010, s. 77}.
...
to możliwość interpersonalnej komunikacji zapóśredniczonej interfejsem
...
inną
technologią\footnote{Ryszard Kluszczyński, \textit{Sztuka interaktywna}, Warszawa 2010, s. 105-109}.
...
wszystkich
miejscInternetu\footnote{Ewa Wójtowicz, \textit{Net art}, Kraków 2008, s. 175-177}.
...
\item hatywizm
%end ewa
\item widz zmienia sie w współtworzącego dzieło
\item podstawą jest komunikacja za pomocą Internetu
\item sieciowość
%TODO pobierznie przeczytać ewę i się odnieść
%TODO: obrobić to co wyżej i zebrać cechy tam wyniemione
\end{itemize}
