...
Ryszard:\textit{Net art jest alternatywnym układem sztuki, który funkcjonuje
...
w cyberprzestrzeni.}
Ewa:\textit{Niematerialna, interaktywna sztuka, której podstawowym podstawowym
...
wikipedia (Net.art => Sztuka internetu): \textit{Sztuka, której głównym
...
%definicja wikipedii (zmieniona od czasu publikacji ewy, bronić wikipedii!)
